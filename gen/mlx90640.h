...
#define MLX90640_STATUS_EN_OV_Pos ((uint16_t)4)
#define MLX90640_STATUS_EN_OV_Msk (((uint16_t)0x0001) << MLX90640_STATUS_EN_OV_Pos)
#define MLX90640_STATUS_EN_OV MLX90640_STATUS_EN_OV_Msk

/* New data available in RAM */
#define MLX90640_STATUS_DATA_READY_Pos ((uint16_t)3)
#define MLX90640_STATUS_DATA_READY_Msk (((uint16_t)0x0001) << MLX90640_STATUS_DATA_READY_Pos)
#define MLX90640_STATUS_DATA_READY MLX90640_STATUS_DATA_READY_Msk

/* Last measured subpage */
#define MLX90640_STATUS_LAST_SUBPAGE_Pos ((uint16_t)0)
#define MLX90640_STATUS_LAST_SUBPAGE_Msk (((uint16_t)0x0007) << MLX90640_STATUS_LAST_SUBPAGE_Pos)
...
#define MLX90640_CONTROL_READING_PATTERN_Pos ((uint16_t)12)
#define MLX90640_CONTROL_READING_PATTERN_Msk (((uint16_t)0x0001) << MLX90640_CONTROL_READING_PATTERN_Pos)
...
/*  */
#define MLX90640_CONTROL_RESOLUTION_CONTROL_Pos ((uint16_t)10)
#define MLX90640_CONTROL_RESOLUTION_CONTROL_Msk (((uint16_t)0x0003) << MLX90640_CONTROL_RESOLUTION_CONTROL_Pos)
...
#define MLX90640_CONTROL_REFRESH_RATE_Pos ((uint16_t)7)
#define MLX90640_CONTROL_REFRESH_RATE_Msk (((uint16_t)0x0007) << MLX90640_CONTROL_REFRESH_RATE_Pos)
...
/*  */
#define MLX90640_CONTROL_SEL_SUBPAGE_Pos ((uint16_t)4)
#define MLX90640_CONTROL_SEL_SUBPAGE_Msk (((uint16_t)0x0007) << MLX90640_CONTROL_SEL_SUBPAGE_Pos)
...
/*  */
#define MLX90640_CONTROL_EN_REPEAT_Pos ((uint16_t)3)
#define MLX90640_CONTROL_EN_REPEAT_Msk (((uint16_t)0x0001) << MLX90640_CONTROL_EN_REPEAT_Pos)
...
/*  */
#define MLX90640_CONTROL_EN_HOLD_Pos ((uint16_t)2)
#define MLX90640_CONTROL_EN_HOLD_Msk (((uint16_t)0x0001) << MLX90640_CONTROL_EN_HOLD_Pos)
...
/*  */
#define MLX90640_CONTROL_EN_SUBPAGE_Pos ((uint16_t)0)
#define MLX90640_CONTROL_EN_SUBPAGE_Msk (((uint16_t)0x0001) << MLX90640_CONTROL_EN_SUBPAGE_Pos)
...
/*  */
#define MLX90640_I2C_CONFIGURATION_DRIVER_LIMIT_Pos ((uint16_t)2)
#define MLX90640_I2C_CONFIGURATION_DRIVER_LIMIT_Msk (((uint16_t)0x0001) << MLX90640_I2C_CONFIGURATION_DRIVER_LIMIT_Pos)
...
/*  */
#define MLX90640_I2C_CONFIGURATION_THRESHOLD_Pos ((uint16_t)1)
#define MLX90640_I2C_CONFIGURATION_THRESHOLD_Msk (((uint16_t)0x0001) << MLX90640_I2C_CONFIGURATION_THRESHOLD_Pos)
...
/*  */
#define MLX90640_I2C_CONFIGURATION_FM_Pos ((uint16_t)0)
#define MLX90640_I2C_CONFIGURATION_FM_Msk (((uint16_t)0x0001) << MLX90640_I2C_CONFIGURATION_FM_Pos)
