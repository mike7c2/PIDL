...
/*  */
#define TMP102_TEMPERATURE_TEMP_Pos (4u)
#define TMP102_TEMPERATURE_TEMP_Msk ((0x800u) << TMP102_TEMPERATURE_TEMP_Pos)
...
#define TMP102_CONFIGURATION_ONE_SHOT_Pos (15u)
#define TMP102_CONFIGURATION_ONE_SHOT_Msk ((0x1u) << TMP102_CONFIGURATION_ONE_SHOT_Pos)
...
#define TMP102_CONFIGURATION_RESOLUTION_Pos (13u)
#define TMP102_CONFIGURATION_RESOLUTION_Msk ((0x2u) << TMP102_CONFIGURATION_RESOLUTION_Pos)
#define TMP102_CONFIGURATION_RESOLUTION TMP102_CONFIGURATION_RESOLUTION_Msk

/* Control number of faults to trigger alarm */
#define TMP102_CONFIGURATION_FAULT_QUEUE_Pos (11u)
#define TMP102_CONFIGURATION_FAULT_QUEUE_Msk ((0x2u) << TMP102_CONFIGURATION_FAULT_QUEUE_Pos)
...
#define TMP102_CONFIGURATION_POLARITY_Pos (10u)
#define TMP102_CONFIGURATION_POLARITY_Msk ((0x1u) << TMP102_CONFIGURATION_POLARITY_Pos)
...
#define TMP102_CONFIGURATION_THERMOSTAT_Pos (9u)
#define TMP102_CONFIGURATION_THERMOSTAT_Msk ((0x1u) << TMP102_CONFIGURATION_THERMOSTAT_Pos)
#define TMP102_CONFIGURATION_THERMOSTAT TMP102_CONFIGURATION_THERMOSTAT_Msk

/* Shutdown mode enables when the SD bit is */
#define TMP102_CONFIGURATION_SHUTDOWN_MODE_Pos (8u)
#define TMP102_CONFIGURATION_SHUTDOWN_MODE_Msk ((0x1u) << TMP102_CONFIGURATION_SHUTDOWN_MODE_Pos)
...
#define TMP102_CONFIGURATION_ALERT_Pos (5u)
#define TMP102_CONFIGURATION_ALERT_Msk ((0x1u) << TMP102_CONFIGURATION_ALERT_Pos)
#define TMP102_CONFIGURATION_ALERT TMP102_CONFIGURATION_ALERT_Msk

/*  */
#define TMP102_CONFIGURATION_EXTENDED_MODE_Pos (5u)
#define TMP102_CONFIGURATION_EXTENDED_MODE_Msk ((0x1u) << TMP102_CONFIGURATION_EXTENDED_MODE_Pos)
...
/*  */
#define TMP102_TLOW_FIELD_Pos (4u)
#define TMP102_TLOW_FIELD_Msk ((0x800u) << TMP102_TLOW_FIELD_Pos)
...
/*  */
#define TMP102_THIGH_FIELD_Pos (4u)
#define TMP102_THIGH_FIELD_Msk ((0x800u) << TMP102_THIGH_FIELD_Pos)
