...
*/
#define TMP102_TEMPERATURE_INDEX 0

/*  */
#define TMP102_TEMPERATURE_TEMP_Pos (4)
#define TMP102_TEMPERATURE_TEMP_Msk ((0xfff) << TMP102_TEMPERATURE_TEMP_Pos)
...
*/
#define TMP102_CONFIGURATION_INDEX 1

/* When the device is in Shutdown Mode, writing a 1 to the OS bit starts a single temperature conversion. */
#define TMP102_CONFIGURATION_ONE_SHOT_Pos (15)
#define TMP102_CONFIGURATION_ONE_SHOT_Msk ((0x1) << TMP102_CONFIGURATION_ONE_SHOT_Pos)
...
#define TMP102_CONFIGURATION_RESOLUTION_Pos (13)
#define TMP102_CONFIGURATION_RESOLUTION_Msk ((0x3) << TMP102_CONFIGURATION_RESOLUTION_Pos)
#define TMP102_CONFIGURATION_RESOLUTION TMP102_CONFIGURATION_RESOLUTION_Msk

/* Control number of faults to trigger alarm */
#define TMP102_CONFIGURATION_FAULT_QUEUE_Pos (11)
#define TMP102_CONFIGURATION_FAULT_QUEUE_Msk ((0x3) << TMP102_CONFIGURATION_FAULT_QUEUE_Pos)
#define TMP102_CONFIGURATION_FAULT_QUEUE TMP102_CONFIGURATION_FAULT_QUEUE_Msk
#define TMP102_CONFIGURATION_FAULT_QUEUE_1FAULT (0 << TMP102_CONFIGURATION_FAULT_QUEUE_Pos)        /* 1 Consecutive fault*/
#define TMP102_CONFIGURATION_FAULT_QUEUE_2FAULT (1 << TMP102_CONFIGURATION_FAULT_QUEUE_Pos)        /* 2 Consecutive fault*/
#define TMP102_CONFIGURATION_FAULT_QUEUE_4FAULT (2 << TMP102_CONFIGURATION_FAULT_QUEUE_Pos)        /* 4 Consecutive fault*/
#define TMP102_CONFIGURATION_FAULT_QUEUE_6FAULT (3 << TMP102_CONFIGURATION_FAULT_QUEUE_Pos)        /* 6 Consecutive fault*/

/* If the POL bit is set to 0 (default), the ALERT pin becomes active low. */
#define TMP102_CONFIGURATION_POLARITY_Pos (10)
#define TMP102_CONFIGURATION_POLARITY_Msk ((0x1) << TMP102_CONFIGURATION_POLARITY_Pos)
...
#define TMP102_CONFIGURATION_THERMOSTAT_Pos (9)
#define TMP102_CONFIGURATION_THERMOSTAT_Msk ((0x1) << TMP102_CONFIGURATION_THERMOSTAT_Pos)
#define TMP102_CONFIGURATION_THERMOSTAT TMP102_CONFIGURATION_THERMOSTAT_Msk

/* Shutdown mode enables when the SD bit is */
#define TMP102_CONFIGURATION_SHUTDOWN_MODE_Pos (8)
#define TMP102_CONFIGURATION_SHUTDOWN_MODE_Msk ((0x1) << TMP102_CONFIGURATION_SHUTDOWN_MODE_Pos)
#define TMP102_CONFIGURATION_SHUTDOWN_MODE TMP102_CONFIGURATION_SHUTDOWN_MODE_Msk

/*  */
#define TMP102_CONFIGURATION_CONVERSION_RATE_Pos (6)
#define TMP102_CONFIGURATION_CONVERSION_RATE_Msk ((0x3) << TMP102_CONFIGURATION_CONVERSION_RATE_Pos)
#define TMP102_CONFIGURATION_CONVERSION_RATE TMP102_CONFIGURATION_CONVERSION_RATE_Msk
#define TMP102_CONFIGURATION_CONVERSION_RATE_HZ25 (0 << TMP102_CONFIGURATION_CONVERSION_RATE_Pos)        /* 0.25 Hz*/
#define TMP102_CONFIGURATION_CONVERSION_RATE_1HZ (1 << TMP102_CONFIGURATION_CONVERSION_RATE_Pos)        /* 1 Hz*/
#define TMP102_CONFIGURATION_CONVERSION_RATE_4HZ (2 << TMP102_CONFIGURATION_CONVERSION_RATE_Pos)        /* 4 Hz (default)*/
#define TMP102_CONFIGURATION_CONVERSION_RATE_8HZ (3 << TMP102_CONFIGURATION_CONVERSION_RATE_Pos)        /* 8 Hz*/

/* Active high alarm bit */
#define TMP102_CONFIGURATION_ALERT_Pos (5)
#define TMP102_CONFIGURATION_ALERT_Msk ((0x1) << TMP102_CONFIGURATION_ALERT_Pos)
#define TMP102_CONFIGURATION_ALERT TMP102_CONFIGURATION_ALERT_Msk

/*  */
#define TMP102_CONFIGURATION_EXTENDED_MODE_Pos (5)
#define TMP102_CONFIGURATION_EXTENDED_MODE_Msk ((0x1) << TMP102_CONFIGURATION_EXTENDED_MODE_Pos)
#define TMP102_CONFIGURATION_EXTENDED_MODE TMP102_CONFIGURATION_EXTENDED_MODE_Msk
#define TMP102_CONFIGURATION_EXTENDED_MODE_NORMAL_MODE (0 << TMP102_CONFIGURATION_EXTENDED_MODE_Pos)        /* */
#define TMP102_CONFIGURATION_EXTENDED_MODE_EXTENDED_MODE (1 << TMP102_CONFIGURATION_EXTENDED_MODE_Pos)        /* */
...
*/
#define TMP102_TLOW_INDEX 2

/*  */
#define TMP102_TLOW_FIELD_Pos (4)
#define TMP102_TLOW_FIELD_Msk ((0xfff) << TMP102_TLOW_FIELD_Pos)
...
*/
#define TMP102_THIGH_INDEX 3

/*  */
#define TMP102_THIGH_FIELD_Pos (4)
#define TMP102_THIGH_FIELD_Msk ((0xfff) << TMP102_THIGH_FIELD_Pos)
